    ...
    def get_option(self):
        ...
        return dict(
            ...
            choice=[
                ...
                dict(opt="dbname", type="str", default="gaian", required=True, multi=False, hide=True, choice=None,
                ...
                dict(opt="llmprov", type="str", default="azureopenai", required=False, multi=False, hide=False,
                     ...
                     choice_show=dict(azureopenai=["llmapikey", "llmendpoint", "llmmodel"],
                                      openai=["llmapikey", "llmendpoint", "llmmodel"],
                                      vertexai=["llmprojectid", "llmsvaccountfile", "llmlocation", "llmmodel"],
